...
(function() {
	var ctrls = angular.module('mpd.controllers', []);
	ctrls.controller('ServerSideEventCtrl', function($rootScope, $scope, constant) {
		$scope.msg = {};
	...
	ctrls.controller('PlaylistInfoCtrl', function($rootScope, $scope, $http, $filter, constant) {
		$scope.headers = [
			"Time",
			"Artist",
			"Title",
	...
	ctrls.controller('StatusCtrl', function($rootScope, $scope, $http, constant) {
